...
export default function App() {
    ...
    const [activeNav, setActiveNav] = useState<PageKey>('demos')
        ...
        <div className="app-layout">
            <aside className="sidebar">
                ...
                <div className="sidebar-footer">
                    <a href="https://www.npmjs.com/package/@mustrd/form" target="_blank" rel="noreferrer">
                        <span className="nav-icon">↗</span>
                        npm
                    </a>
                    <a href="https://github.com/niclin/mustard" target="_blank" rel="noreferrer">
                        <span className="nav-icon">↗</span>
                        GitHub
                    </a>
                    <a href="/mustard/">
